...
If OpenWindow(#windowabout,0,0,370,170,about$,#PB_Window_WindowCentered|#PB_Window_SystemMenu, WindowID(#window))
  
  ImageGadget(#PB_Any,10,10,260,20,ImageID(#imgicon))
  TextGadget(#PB_Any,150,25,220,20,title$+ " v" + version$)
